        ...
        <div class="header-navigation">
          <ul>
            ...
            <?php if(!Yii::app()->user->isGuest){ ?>
              <li><a href="<?php echo Yii::app()->request->baseUrl; ?>/products/admin" <?php if($this->section == "administration")echo "style='color:#E02222;'";?>> Administrar</a>
                <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu">
                  ...
                  <li><a href="<?php echo Yii::app()->request->baseUrl; ?>/bannerImages/admin" <?php if($this->subSection == "banner")echo "style='color:#E02222;'";?>>Banner</a></li>
                </ul>              
              </li>
